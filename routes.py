    ...
    if request.method=="GET":
        ...
        if session["csrf_token"] != request.form["csrf_token"]:
            ...
            if quizzes.check_quizname(quizname)==True:
                ...
                message = (f"Success! Please continue to set questions and options. Submit all questions and options at once, you can't edit them later. All fields are required and questions must be unique.")
                #quizzes.create_quiz(quizname, username)
