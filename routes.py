    ...
    if request.method=="GET":
        ...
        if session["csrf_token"] != request.form["csrf_token"]:
            ...
            if len(questions) != len(set(questions)):
                error = f"All questions must be unique, you can't have same question repeated in a quiz. Please check your questions again. Remember to choose the category as well."
                return render_template("newquiz.html", error=error, username=username, quizname=quizname, category=category, question1=question1, option11=option11, option12=option12, option13=option13, question2=question2, option21=option21, option22=option22, option23=option23, question3=question3, option31=option31, option32=option32, option33=option33, question4=question4, option41=option41, option42=option42, option43=option43, question5=question5, option51=option51, option52=option52, option53=option53)
            else:
    ...
    if request.method=="GET":
        ...
        if session["csrf_token"] != request.form["csrf_token"]:
            ...
            if quizzes.check_quizname(quizname)==True:
                ...
                message = (f"Success! Please continue to choose a category and set questions and options. Submit all questions and options at once, you can't edit them later. All fields are required and questions must be unique.")
                #quizzes.create_quiz(quizname, username)
